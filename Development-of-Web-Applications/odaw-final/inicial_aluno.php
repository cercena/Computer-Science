...
$(document).ready(function(){
  ...
  //disciplinas
  $.post('http://localhost/servidor/aluno_disciplinas.php',   // url
     {
...
function acessar_disciplina(id_disciplina, nome_disciplina){
    // alert(id_disciplina +";"+ nome_disciplina);
      var myForm = '<form id="ff" action="/disciplina_aluno.php" method="POST">\
...
<h1>Bem vindo <?php echo $_SESSION['nome'];?> ao Portal do Aluno</h1>
